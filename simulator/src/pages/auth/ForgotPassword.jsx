    ...
    <AuthLayout>
      <div className="w-full max-w-md">
        ...
        <form
          ...
          className="space-y-5 bg-[#0b1220] rounded-2xl shadow-2xl shadow-black/40 p-8 sm:p-10"
        >
          {/* Email Input */}
          <div>
          ...
          <button
            type="submit"
            disabled={isLoading}
            className="w-full bg-[#CED87C] text-black font-semibold py-3 rounded-xl hover:opacity-90 transition flex items-center justify-center gap-2"
          >
            <span>
              {isLoading ? "Sending reset link..." : "Send reset link"}
            </span>
            <img
              src="\images\upicon.svg" // logo path
              alt="reset icon"
              className="h-5 w-5"
            />
          </button>
        ...
        <div className="mt-6 text-center text-sm text-slate-400">
          <Link
            to="/login"
            className="text-white hover:underline flex items-center gap-1 justify-center inline-flex"
          >
            <img
              src="/images/backicon.svg" // logo path
              alt="back icon"
              className="h-4 w-4"
            />
            Back to login
